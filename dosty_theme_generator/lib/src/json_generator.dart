...
class DostyGenerator extends GeneratorForAnnotation<DostyTheme> {
  ...
  String generateForAnnotatedElement(
    ...
    buffer.writeln('  late List<DostyColor> myColors;');
    ...
    buffer.writeln('');
    buffer.writeln(
        '  _\$$className({List<DostyColor>? myColors, ThemeMode mode = ThemeMode.system}) {');
    ...
    // Generate the `DostyTheme` method
    buffer.writeln('  ValueListenableBuilder DostyTheme({');
...
''');
    ...
    buffer.writeln('  Widget DostyThemeBuilder({');
    buffer.writeln(
